...
function U(e = {}, t = {}) {
  Object.keys(t).forEach((s) => {
    typeof e[s] > "u"
      ? (e[s] = t[s])
      : ee(t[s]) && ee(e[s]) && Object.keys(t[s]).length > 0 && U(e[s], t[s]);
  });
}
const le = {
  body: {},
    ...
    if (
      ...
      if (i.slidesPerView === "auto") {
        ...
        if (
          ...
          M = e.isHorizontal() ? se(y, "width", !0) : se(y, "height", !0);
        else {
          const K = s(C, "width"),
            me = s(C, "padding-left"),
...
const N = (e, t) => {
  ...
  q = (e) => {
    ...
    if (e.params.grid && e.params.grid.rows > 1) {
      const l = r,
        a = [l - t];
      a.push(...Array.from({ length: t }).map((o, d) => l + i + d)),
    ...
    if (e.params.rewind || e.params.loop)
      ...
      for (let l = Math.max(r - t, 0); l <= Math.min(n + t, s - 1); l += 1)
        l !== r && (l > n || l < r) && W(e, l);
  };
function He(e) {
